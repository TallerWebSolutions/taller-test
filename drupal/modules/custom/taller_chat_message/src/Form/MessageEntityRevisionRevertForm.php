...
class MessageEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity.manager')->getStorage('message'),
  ...
  public function getFormId() {
    return 'message_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Message %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\taller_chat_message\Entity\MessageEntityInterface $revision
