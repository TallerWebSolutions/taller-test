 ...
 * @endcode
 */
$settings['hash_salt'] = 'I1H2PfnRN_-GMYeGRmmU_287Qr6SE6QvfXbLtJnWAqRqfH6JgAez-1ToOFjbe4ojfLyO0epl0w';
...
$settings['install_profile'] = 'taller_chat';
...
/**
 * Acquia environment specific settings. They must be overridden in
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  // Enable Acquia config split.
  $config['config_split.config_split.acquia']['status'] = TRUE;

  if ($_ENV['AH_SITE_ENVIRONMENT'] === 'prod') {
    // Enable Acquia config split.
    $config['config_split.config_split.acquia_prod']['status'] = TRUE;
  }
